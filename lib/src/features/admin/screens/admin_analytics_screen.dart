...
class AdminAnalyticsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Analytics & Reports', style: TextStyle(fontWeight: FontWeight.w600)),
        centerTitle: true,
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    _SummaryCard(
                      label: 'Total Users',
                      value: (analytics['total_users'] ?? 0).toString(),
                ...
                Row(
                  ...
                  children: [
                    ...
                    _SummaryCard(
                      label: 'Pending Items',
                      value: '${(analytics['pending_approvals'] ?? 0) + (analytics['pending_payments'] ?? 0)}',
                        ...
                        SizedBox(
                          ...
                          child: LineChart(
                            ChartService.createUserGrowthChart(
                              analytics['user_growth'] ?? ChartService.getSampleUserGrowthData(),
                            ),
                          ),
                        ),
                      ],
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Journey Statistics', style: Theme.of(context).textTheme.titleMedium),
                        const SizedBox(height: 16),
                        SizedBox(
                          height: 200,
                          child: BarChart(
